...
Prisioneiro(\underline{ idPessoa} $\rightarrow$ Pessoa, dataEntrada, dataSaída, cela $\rightarrow$ Cela)\\
Funcionário(\underline{idPessoa} $\rightarrow$ Pessoa, cargo, horaEntrada, horaSaída, dataContratação, vencimento)\\
