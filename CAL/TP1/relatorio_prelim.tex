...
\subsection*{Estruturas de dados a utilizar}
\begin{itemize}
\item Grafos
...
\begin{itemize}
\item Um grafo  $G= ( V, E ) $, onde $V$ é o conjunto das casas e $E$ o conjunto das suas ligaçoes e para cada aresta $(u,v)\in E$ temos $w(u,v)$ representando a distância entre as arestas $u$ e $v$ e $d(p)$ como sendo a distância de um caminho $p = \langle v_0,v_1,\ldots , v_k\rangle$;
...
$$\sum_{(u,v)\in (S,S)} x(u,v) \leq |S| - 1 \forall S \subseteq V_T$$
