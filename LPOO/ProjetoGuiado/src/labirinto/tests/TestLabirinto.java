...
public class TestLabirinto{
	...
	public void testPickUpSword(){
		...
		assertEquals(Character.valueOf('E'), testLab.getCellSymbol(new Posicao(6, 4)));
		testLab.move(Direcao.BAIXO);
		assertTrue(testLab.getHeroi().isArmado());	
		assertEquals(Character.valueOf('A'), testLab.getCellSymbol(testLab.getHeroi().getPosicao()));
		testLab.move(Direcao.CIMA);
		assertEquals(Character.valueOf(' '), testLab.getCellSymbol(new Posicao(6, 4)));
	...
	public void testSlayDragon(){
		...
		assertEquals(Character.valueOf('D'), testLab.getCellSymbol(new Posicao(7, 4)));
		testLab.move(Direcao.BAIXO);
		assertTrue(testLab.nenhumDragao());
		assertEquals(Character.valueOf(' '), testLab.getCellSymbol(new Posicao(7, 4)));
	}
