...
public class Interface {
	...
	public static void main(String[] args) throws IOException {	
		...
		while(option != 1){
			...
			System.out.print("1. ComeÁar jogo\n2. Tutorial\n3. Sair\n");
			do{
				try{
					System.out.print("Insira uma opÁ„o: ");
		...
		do{
			try{
				System.out.println("\n\n\nInsira dimens√£o pretendida para o labirinto (deve ser um numero impar), ou -1 para o labirinto padrao:");
		...
		System.out.println("Este jogo tem ‡ sua disposiÁ„o v·rios modos relativos ao comportamento dos dragoes. S„o eles: \n"
	...
	//	InputType tipo;
		...
		do
		{
			...
			case INSIGNIFICANTE:
				break;
			default:
				//System.out.println("Entrada n√£o reconhecida ou inutil...");
				break;
			}
	...
	private static void tutorial(){
		System.out.print("Comandos: \nW - Cima\nA - Esquerda\nS - Baixo\nD - Direita\nT - Atirar dardo (deve ser seguido de uma das direcÁıes acima)\n\n"
				+"O objectivo do herÛi (H) È chegar ‡ saÌda do labirinto (S) apÛs ter matado todos os dragıes (D).\n" + 
				"Para matar dragıes, o herÛi necessita de uma espada (E) ou dardo (J) e do escudo (P), que podem ser encontrados espalhados pelo labirinto.\n"+
				"O heÛi sÛ pode ter um dardo ou uma espada em qualquer momento." + "Se o herÛi chegar perto de um drag„o sem o escudo, ser· instantaneamente comido, ou esturricado.\n\n\n");
	}
